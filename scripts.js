(function() {
	...
	function createCalculatingTable() {
		...
		var tf1 = document.createElement('td'); tf1.innerHTML = 'Total';
		var tf2 = document.createElement('td'); tf2.innerHTML = sumOfECTS;
		var tf3 = document.createElement('td'); tf3.innerHTML = sumOfGradesTimesECTS/sumOfECTS;
